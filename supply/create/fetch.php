...
<div class="table-responsive tscroll">
    <table id="detail_table" class="table-bordered" style="width: 100%;">
        ...
        <?php
                $no_ = 0;
                $unitversity = mysqli_query($conn,"select * from university where uni_id='$uni_id' ORDER BY uni_name ASC;");
...
$('.demandBtn').on('click', function() {
    ...
    $u = mysqli_query($conn,"select * from university where uni_id='$uni_id'");
    foreach($u as $un){
        $u_id = $un['uni_id'];
