    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-3 dropdown">
            ...
            <select name="status" id="status" style="width: 500px;text-align-last: center;" class="form-control">
                ...
                <?php
                    $fy = mysqli_query($conn, "SELECT adj_id,ad.fy_id,ad.dept_id,dept_name FROM adjust ad left JOIN fy ON ad.fy_id=fy.fy_id left JOIN department d ON ad.dept_id=d.dept_id WHERE fy.status=1");
