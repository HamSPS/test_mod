...
class obj{
    ...
    public static function insert_fy($fy_id,$qty_s,$qty_c,$qty_i,$qty_q,$status,$pdf_file){
        global $conn;
        global $path;
        ...
        if(mysqli_num_rows($check_id)){
            ...
            $result = mysqli_query($conn, "call insert_fy('$pdf','$status','$fy_id','$qty_s','$qty_c','$qty_i','$qty_q');");
            if (!$result) {
                echo"<script>";
    ...
    public static function update_fy($fy_id,$qty_s,$qty_c,$qty_i,$qty_q,$status,$pdf_file){
        global $conn;
        global $path;
        ...
        if($pdf_file == ""){
            ...
            $result = mysqli_query($conn, "call update_fy('$pdf','$status','$qty_s','$qty_c','$qty_i','$qty_q','$fy_id');");
            if (!$result) {
                echo"<script>";
    ...
    public static function insert_province($p_m_name){
        global $conn;

        $result = mysqli_query($conn, "call insert_province('$p_m_name')");
        if (!$result) {
            echo"<script>";
    ...
    public static function update_province($p_m_id,$p_m_name){
        global $conn;

        $result = mysqli_query($conn, "call update_province('$p_m_id','$p_m_name')");
        if (!$result) {
            echo"<script>";
            echo"window.location.href='province?msg=fail';";
            echo"</script>";
