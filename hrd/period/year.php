<?php
  ...
  if (isset($_POST['Save'])) {
      $obj->insert_fy(trim($_POST['Fy_ID']),trim($_POST['Qty_s']),trim($_POST['Qty_c']),trim($_POST['Qty_i']),trim($_POST['Qty_q']),trim($_POST['status']),$_FILES['pdf']['name']);
  }
  if (isset($_POST['btnUpdate'])) {
    $obj->update_fy(trim($_POST['Fy_ID_update']),trim($_POST['Qty_s_update']),trim($_POST['Qty_c_update']),trim($_POST['Qty_i_update']),trim($_POST['Qty_q_update']),trim($_POST['status_update']),$_FILES['file_update']['name']);
  }
...
<form action="year" method="POST">
    <div class="table-responsive">
        <div class="row">
            <div class="col-md-8">
                <button type="button" data-toggle="modal" data-target="#exampleModalDelete_many" class="btn btn-danger"><i
                ...
                <div class="modal-body">
                    <div class="row" align="left">
                        <div class="col-md-12 col-sm-6">
                            ...
                            <label>ຈຳນວນນັກຮຽນ ມ.7</label>
                            <input type="text" class="form-control" name="Qty_s_update" id="Qty_s_update" placeholder="ຈຳນວນ"
                                required>
                            <div class="invalid-feedback">
                                ກະລຸນາປ້ອນຈຳນວນນັກຮຽນ ມ.7
                            </div>
                        ...
                        <div class="col-md-12 col-sm-6">
                            <label>ຈຳນວນນັກຮຽນຕໍ່ເນື່ອງ</label>
                            <input type="text" class="form-control" name="Qty_c_update" id="Qty_c_update" placeholder="ຈຳນວນ"
                                required>
                            <div class="invalid-feedback">
                                ກະລຸນາປ້ອນຈຳນວນນັກຮຽນຕໍ່ເນື່ອງ
                            </div>
                        ...
                        <div class="col-md-12 col-sm-6">
                            <label>ຈຳນວນນັກຮຽນ ມ.7 ຮຽນຕໍ່ພາຍໃນ</label>
                            <input type="text" class="form-control" name="Qty_i_update" id="Qty_i_update" placeholder="ຈຳນວນ"
                                required>
                            <div class="invalid-feedback">
                                ກະລຸນາປ້ອນຈຳນວນນັກຮຽນ ມ.7 ຮຽນຕໍ່ພາຍໃນ
                            </div>
                        ...
                        <div class="col-md-12 col-sm-6">
                            <label>ຈຳນວນນັກສືກສາລະບົບຕໍ່ເນື່ອງ</label>
                            <input type="text" class="form-control" name="Qty_q_update" id="Qty_q_update" placeholder="ຈຳນວນ"
                                required>
                            <div class="invalid-feedback">
                                ກະລຸນາປ້ອນຈຳນວນນັກສຶກສາລະບົບຕໍ່ເນື່ອງ
                            </div>
...
$(document).on("click", ".btnUpdate_year", function() {
    ...
    $('#Qty_s_update').val(data[11]);
    $('#Qty_c_update').val(data[12]);
    $('#Qty_i_update').val(data[13]);
    $('#Qty_q_update').val(data[14]);
    $('#Fy_ID_update').val(data[3]);
    $('#status_update').val(data[10]);
})
</script>