...
if($_SESSION["uni_id"] == "HRD1"){
    ...
    WHERE ad.adj_id='$adj_id' AND d.dept_id='$dept_id' AND u.uni_id NOT IN ($uni_array) GROUP BY u.uni_id ORDER BY uni_name ASC;");
    ...
    LEFT JOIN department d ON u.dept_id=d.dept_id
    LEFT JOIN adjust a ON ad.adj_id=a.adj_id
    WHERE ad.adj_id='$adj_id' AND d.dept_id='$dept_id' AND u.uni_id='$_SESSION[uni_id]' GROUP BY u.uni_id ORDER BY uni_name ASC;");
}
...
<div class="table-responsive tscroll">
    ...
    <table id="detail_table" class="table-bordered" style="width: 3000px;">
        ...
        <tr class="child-<?= $fac_id ?>" style="display: table-row;">
            ...
            <td>
                <i style="cursor: pointer;" class="fa fa-info toolcolor btnUpdate_cust" style="margin-left:20px;"></i>
                <small style="font-size:16px;margin-left:40px;"><?= $cour['course_name'] ?>
                </small>
            </td>
