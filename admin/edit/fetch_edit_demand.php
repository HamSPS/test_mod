...
<div class="table-responsive tscroll">
    ...
    <table id="detail_table" class="table-bordered" style="width: 1600px;">
        ...
        <?php
                ...
                LEFT JOIN course c ON cp.course_id=c.course_id
                LEFT JOIN faculty f ON c.fac_id=f.fac_id
                WHERE adj_id='$adj_id' AND uni_id='$uni_id'
        ...
        <?php
                ...
                WHERE adj_id='$adj_id' AND c.fac_id='$fac_id' ORDER BY level_name ASC,course_name ASC;");
                $no_j = 0;
...
$('.demandBtn').on('click', function() {
    ...
    foreach($u as $un){
        ...
        LEFT JOIN course c ON cp.course_id=c.course_id
        LEFT JOIN faculty f ON c.fac_id=f.fac_id
        WHERE adj_id='$a_id' AND uni_id='$u_id'
        GROUP BY c.fac_id;");
        ...
        foreach($f as $fc){
            ...
            LEFT JOIN user u ON cp.user_id=u.user_id
            LEFT JOIN demand_user du ON u.user_id=du.user_id
            WHERE adj_id='$a_id' AND c.fac_id='$f_id';");
    ...
    <?php
            ...
            LEFT JOIN course c ON cp.course_id=c.course_id
            LEFT JOIN faculty f ON c.fac_id=f.fac_id
            WHERE adj_id='$a_id' AND uni_id='$u_id' AND c.fac_id='$f_id'
